...
import com.example.simplechatapp.Services.MyFCMService;
...
public class Common {
    ...
    public static final String NOTI_ROOM_ID = "room";
    ...
    public static void showNotification(Context context, int id,
        ...
        String NOTIFICATION_CHANNEL_ID = "com.example.simplechatapp";
